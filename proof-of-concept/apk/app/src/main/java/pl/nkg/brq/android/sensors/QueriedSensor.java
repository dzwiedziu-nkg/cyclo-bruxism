...
public abstract class QueriedSensor extends SingleValueSensor{
    ...
    private void acquireNewValue() {
        setValue(acquireValueFromInternal());
    }

    protected abstract double acquireValueFromInternal();
}
